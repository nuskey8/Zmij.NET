...
Zimij.NET is a C# port of [Zmij](https://github.com/vitaut/zmij).
...
```bash
dotnet add package Zimij
```

### Unity

In Unity, you can install Zimij.NET from [NuGetForUnity](https://github.com/GlitchEnzo/NuGetForUnity)

## Quick Start

```cs
using ZimijNet; // namespace

double value = 1.234567890123456;
Console.WriteLine(Zimij.ToString(value)); // 1.234567890123456
...
| Zimij_ToString        | 421.3 us |  8.29 us | 12.16 us |
| Zimij_TryWrite        | 323.2 us |  3.97 us |  3.52 us |
